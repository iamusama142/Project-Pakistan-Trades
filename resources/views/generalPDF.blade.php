...
<body>
            ...
            <div class="centered">
                <div class="container col-sm-6">
                    ...
                    <p  class="f" style="font-size: 15px; margin-top:-15px;">Date:
                        <span
                            style="color: red; font-size:20px;">{{ date('d-m-Y', strtotime($lists->date)) }}</span>
                    </p>
                    <p class="f">(Journal Voucher)</p>
                    <table style="width:100%" cellspacing="2" cellpadding="5">
                        <tr>
                            ...
                            <td class="   " colspan="3">Credit</td>
                            <td class="" colspan="3"">Debit</td>
 ...
 @foreach ($grouplist as $lists)
                        ...
                        <tr>
                            ...
                            <td class="" colspan="3">{{ $lists->description }}</td>
                            <td class="" colspan="3">{{ $lists->cvammount }}</td>
                            <td class="" colspan="3">{{ $lists->dvammount }}</td>
                        </tr>
                        @endforeach
