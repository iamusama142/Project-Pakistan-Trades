                                        ...
                                        <tbody>
                                            @foreach ($ViewsPage as $ViewsPages)
                                                <tr>
                                                    ...
                                                    <td>{{ $ViewsPages->p_gateno }}</td>
                                                    <td>{{ $ViewsPages->p_vehicleno }}</td>
                                                    <td>
                                                        <?php
                                                    ...
                                                    <td>{{ $ViewsPages->p_product }}</td>
                                                    <td>{{ $ViewsPages->p_bouritotal }}</td>
                                                    <td>{{ $ViewsPages->p_thelatotal }}</td>
                                                    <td>{{ $ViewsPages->p_firstwt }}</td>
                                                    <td>{{ $ViewsPages->barrsdifference }}</td>
                                                    <td>{{ $ViewsPages->wtdifference }}</td>
                                                    <td>{{ $ViewsPages->ratedifference }}</td>
                                                    <td>{{ $ViewsPages->p_barrs }}</td>
