...
@section('content')
                ...
                <section role="main" class="content-body card-margin">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <section class="card ">
                                <form action="{{ route('data.store') }}" method="post" id="butsave">
                                    @csrf
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <center><label class="col-form-label" for="formGroupExampleInput">
                                                            <h3 class="text-dark">Purchaser Form</h3>
                                                        </label>
                                                    </center>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">Invoice
                                                        Number</label>
                                                    <?php $posts = App\Models\pakTrader::latest()->first('invoiceno');
                                                    $count = App\Models\pakTrader::all()->count();
                                                    ?>
                                                    <?php
                                                           if($count==0)
                                                                {
                                                    ...
                                                    <input type="text" name="inv" class="form-control"
                                                        id="formGroupExampleInput" placeholder="Invoice Number" value="1"
                                                        readonly>
                                                    <?php
                                                    }
                                                           else if($count==2)
                                                                {
                                                                        ?>
                                                    <input type="text" name="inv" class="form-control"
                                                        id="formGroupExampleInput" placeholder="Invoice Number" value="3"
                                                        readonly>
                                                    <?php
                                                    }
                else {
                    ?>
                                                    <input type="text" name="inv" class="form-control"
                                                        id="formGroupExampleInput" placeholder="Invoice Number"
                                                        value="{{ $posts->invoiceno + 1 }}" readonly>
                                                    <?php
                                                    }
                                                        ?>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <select id="purchaserName" data-plugin-selectTwo
                                                        ...
                                                        <option hidden="">Select Purchaser Name</option>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <select data-plugin-selectTwo class="form-control populate cus12"
                                                        id="saleName" name="saleName">
                                                        <option hidden="">Select Seller Name</option>
                                                        @foreach ($group_show_name as $list)
                                                            <option value="{{ $list->id }}">{{ $list->accountname }}
                                                            </option>
                                                        @endforeach
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="0" name="weightPurchase"
                                                        class="form-control" id="wt1" placeholder="Prodcut" value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="0" name="bouriPurchase" class="form-control"
                                                        id="bourisale" placeholder="Bouri" value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bouri2Purchase" class="form-control"
                                                        id="bourisale2" placeholder="Bouri" value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bouri2PurchaseRate" class="form-control"
                                                        id="bourisalerate2" placeholder="Bouri" value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thelaPurchase" class="form-control"
                                                        id="thelasale" placeholder="Thela" value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thelaRatePurchase" class="form-control"
                                                        id="thelasalerate" placeholder="Thela Rate" value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thela2Purchase" class="form-control"
                                                        id="thelasale2" placeholder="Thela" value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thela2RatePurchase" class="form-control"
                                                        id="thelasalerate2" placeholder="Thela Rate" value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">B. Wt</label>
                                                    <input type="number" name="bwtPurchase" class="form-control"
                                                        id="bwtsaler" placeholder="Prodcut" value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">E. Wt</label>
                                                    <input type="number" name="ewtPurchase" class="form-control" id="ewt"
                                                        placeholder="E. Wt" value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="netPurchase" class="form-control"
                                                        id="netwt1" readonly placeholder="Net. Wt" value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">Rate</label>
                                                    <input type="number" name="ratePurchase" class="form-control"
                                                        id="rate" placeholder="Rate" value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">Total
                                                        Amount</label>
                                                    <input type="number" name="totalAmountPurchase" class="form-control"
                                                        id="totalamount" readonly placeholder="Total Amount" value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="barRatePurchase" class="form-control"
                                                        id="barrate" readonly placeholder="Bar Rs" value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="rentPurchase" class="form-control"
                                                        id="vrent" placeholder="V. Rent" value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="amountPurchase" class="form-control"
                                                        id="netamount" readonly placeholder="Net Amount" value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="weightSale" class="form-control"
                                                        id="1wtpur" placeholder="1st Wt" value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bouriSaleRate" class="form-control"
                                                        id="bouriratepur" placeholder="Bouri" value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">Bouri
                                                        Total</label>
                                                    <input type="number" name="bouriTotalRateSale" class="form-control"
                                                        id="bouritotalpur" placeholder="Bouri" required readonly value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bouri2Sale" class="form-control"
                                                        id="bouri2" placeholder="Bouri" value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bouri2SaleRate" class="form-control"
                                                        id="bouri2ratepur" placeholder="Bouri" value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">Bouri 2
                                                        Total</label>
                                                    <input type="number" name="bouri2TotalRateSale" class="form-control"
                                                        id="bouri2pur" placeholder="Bouri Total" readonly value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thelaSale" class="form-control"
                                                        id="thela1" placeholder="Thela" value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thelaRateSale" class="form-control"
                                                        id="thelarate1" placeholder="Thela Rate" value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">Thela
                                                        Total</label>
                                                    <input type="number" name="thelaTotalRateSale" class="form-control"
                                                        id="thelatotal1" placeholder="Thela Rate" readonly value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thela2Sale" class="form-control"
                                                        id="thela2pur" placeholder="Thela" value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thela2RateSale" class="form-control"
                                                        id="Thela2rate" placeholder="Thela Rate" value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">Thela 2
                                                        Total</label>
                                                    <input type="number" name="thela2TotalRateSale" class="form-control"
                                                        id="thelatotal2pur" placeholder="Thela Rate" readonly value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">B. Wt</label>
                                                    <input type="number" name="bwtSale" class="form-control" id="bwtpur"
                                                        placeholder="B. Wt" value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">E. Wt</label>
                                                    <input type="number" name="ewtSale" class="form-control" id="ewtpur"
                                                        placeholder="E. Wt" value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="netSale" class="form-control"
                                                        id="netwtpur" placeholder="Net. Wt" readonly value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="rateSale" class="form-control"
                                                        id="ratepur" placeholder="Rate" required value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="totalAmountSale" class="form-control"
                                                        id="totalamountpur" placeholder="Total Amount" readonly value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="barRateSale" class="form-control"
                                                        id="barratepur" placeholder="Bar Rs" required readonly value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="rentSale" class="form-control"
                                                        id="vrentput" placeholder="V. Rent" required value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="amountSale" class="form-control"
                                                        id="netamountpur" placeholder="Net Amount" readonly value="0">
                                                </div>
                                            </div>
                                            <hr width="100%">
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput"
                                                        style="font-size: 10px !important;"><b>Purchase Net
                                                            Amount</b></label>
                                                    <input type="number" name="purchaseNetAmount" class="form-control"
                                                        id="purnetamount" placeholder="Purchase Net Amount" readonly
                                                        value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput"
                                                        style="font-size: 10px !important;"><b>Sale Net Amount</b></label>
                                                    <input type="number" name="SaleNetAmount" class="form-control"
                                                        id="salenetamount" placeholder="Sale Net Amount" readonly value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="wtDifference" class="form-control"
                                                        id="wtdifference" placeholder="Bouri Difference" readonly value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bour1RateDifference" class="form-control"
                                                        id="bour1RateDifference" placeholder="1st Bouri Rate Difference"
                                                        readonly value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bour1TotalDifference" class="form-control"
                                                        id="bour1TotalDifference" placeholder="1st Bouri Total Difference"
                                                        readonly value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">2nd Bouri
                                                        Rate Difference</label>
                                                    <input type="number" name="bour2RateDifference" class="form-control"
                                                        id="bour2RateDifference" placeholder="2nd Bouri Rate Difference"
                                                        readonly value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">2nd Bouri
                                                        Total Difference</label>
                                                    <input type="number" name="bour2TotalDifference" class="form-control"
                                                        id="bour2TotalDifference" placeholder="2nd Bouri Total Difference"
                                                        readonly value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thela1Difference" class="form-control"
                                                        id="thela1Difference" placeholder="1st Thela Difference" readonly
                                                        value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">1st Thela
                                                        Rate Difference</label>
                                                    <input type="number" name="thela1RateDifference" class="form-control"
                                                        id="thela1RateDifference" placeholder="1st Thela Rate Difference"
                                                        readonly value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thela1TotalDifference"
                                                        ...
                                                        placeholder="1st Thela Total Difference" readonly value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thela2Difference" class="form-control"
                                                        id="thela2Difference" placeholder="2nd Thela Difference" readonly
                                                        value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">2nd Thela
                                                        Rate Difference</label>
                                                    <input type="number" name="thela2RateDifference" class="form-control"
                                                        id="thela2RateDifference" placeholder="2nd Thela Rate Difference"
                                                        readonly value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thela2TotalDifference"
                                                        ...
                                                        placeholder="2nd Thela Total Difference" readonly value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">Total Amount
                                                        Difference</label>
                                                    <input type="number" name="totalAmountDifference"
                                                        class="form-control" id="totalamountdifference"
                                                        placeholder="Total Amount Difference" readonly value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">Bar. Rs
                                                        Difference</label>
                                                    <input type="number" name="barRateDifference" class="form-control"
                                                        id="barratedifference" placeholder="Bar. Rs Difference" readonly
                                                        value="0">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="formGroupExampleInput">Sale</label>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            // $("#wt1,#ewt,#rate,#netamount").on('change keyup keydown keypress', function() {
            //     var weightone = $("#wt1").val();
            //     $("#bwtsaler,#ewt,#rate,#netamount").val(weightone);
            // });
            $("#bourisale,#bourisalerate,#bwtsaler").on('change keyup keydown keypress', function() {
