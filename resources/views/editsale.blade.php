                ...
                <section role="main" class="content-body card-margin">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <section class="card ">
                                <form action="/updatesale/{{ $wheat_data->id }}" method="post" id="butsave">
                                    @csrf
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <select id="purchaserName" data-plugin-selectTwo
                                                        class="form-control populate cus1" name="purchaserName" required=>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="gateNoSale" class="form-control"
                                                        id="formGroupExampleInput" placeholder="Gate No."      value="{{ $wheat_data->s_gateno }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="vehicleNoSale" class="form-control"
                                                        id="formGroupExampleInput" placeholder="Vehicle No."   value="{{ $wheat_data->s_vehicleno }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="weightSale" class="form-control"
                                                        id="1wtpur" placeholder="1st Wt"    value="{{ $wheat_data->s_firstwt }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bouriSale" class="form-control"
                                                        id="bouripur" placeholder="Bouri"   value="{{ $wheat_data->s_bouri }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bouriSaleRate" class="form-control"
                                                        id="bouriratepur" placeholder="Bouri"    value="{{ $wheat_data->s_bourirate }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bouriTotalRateSale" class="form-control"
                                                        id="bouritotalpur" placeholder="Bouri" required readonly value="{{ $wheat_data->s_bouritotal }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bouri2Sale" class="form-control"
                                                        id="bouri2" placeholder="Bouri"    value="{{ $wheat_data->s_bouritwo }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bouri2SaleRate" class="form-control"
                                                        id="bouri2ratepur" placeholder="Bouri"  value="{{ $wheat_data->s_bouriratetwo }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bouri2TotalRateSale" class="form-control"
                                                        id="bouri2pur" placeholder="Bouri Total" readonly value="{{ $wheat_data->s_bouritwototal }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thelaSale" class="form-control"
                                                        id="thela1" placeholder="Thela"       value="{{ $wheat_data->s_thela }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thelaRateSale" class="form-control"
                                                        id="thelarate1" placeholder="Thela Rate"      value="{{ $wheat_data->s_thelarate }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thelaTotalRateSale" class="form-control"
                                                        id="thelatotal1" placeholder="Thela Rate" readonly    value="{{ $wheat_data->s_thelatotal }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thela2Sale" class="form-control"
                                                        id="thela2pur" placeholder="Thela"   value="{{ $wheat_data->s_thelatwo }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thela2RateSale" class="form-control"
                                                        id="Thela2rate" placeholder="Thela Rate"     value="{{ $wheat_data->s_thelatworate }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thela2TotalRateSale" class="form-control"
                                                        id="thelatotal2pur" placeholder="Thela Rate" readonly   value="{{ $wheat_data->s_thelatwototal }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bwtSale" class="form-control" id="bwtpur"
                                                        placeholder="B. Wt"        value="{{ $wheat_data->s_bwt }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="ewtSale" class="form-control" id="ewtpur"
                                                        placeholder="E. Wt"    value="{{ $wheat_data->s_ewt }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="netSale" class="form-control"
                                                        id="netwtpur" placeholder="Net. Wt" readonly    value="{{ $wheat_data->s_netwt }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="rateSale" class="form-control"
                                                        id="ratepur" placeholder="Rate" required        value="{{ $wheat_data->s_rate }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="totalAmountSale" class="form-control"
                                                        id="totalamountpur" placeholder="Total Amount" readonly         value="{{ $wheat_data->s_totalamount }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="barRateSale" class="form-control"
                                                        id="barratepur" placeholder="Bar Rs" required readonly   value="{{ $wheat_data->s_barrs }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="rentSale" class="form-control"
                                                        id="vrentput" placeholder="V. Rent" required    value="{{ $wheat_data->s_vrent }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="amountSale" class="form-control"
                                                        id="netamountpur" placeholder="Net Amount" readonly    value="{{ $wheat_data->s_netamount }}">
                                                </div>
                                            </div>
                                            <hr width="100%">
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="SaleNetAmount" class="form-control"
                                                        id="salenetamount" placeholder="Sale Net Amount" readonly      value="{{ $wheat_data->salenetamount }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="wtDifference" class="form-control"
                                                        id="wtdifference" placeholder="Bouri Difference" readonly  value="{{ $wheat_data->firstwtdifference }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bour1RateDifference" class="form-control"
                                                        ...
                                                        readonly   value="{{ $wheat_data->firstbouriratedifference }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bour1TotalDifference" class="form-control"
                                                        ...
                                                        readonly    value="{{ $wheat_data->firstbouritotaldifference }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bour2RateDifference" class="form-control"
                                                        ...
                                                        readonly value="{{ $wheat_data->seconfbouriratedifference }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bour2TotalDifference" class="form-control"
                                                        ...
                                                        readonly    value="{{ $wheat_data->seconfbouritotaldifference }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thela1Difference" class="form-control"
                                                        ...
                                                        value="{{ $wheat_data->firsttheladifference }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thela1RateDifference" class="form-control"
                                                        ...
                                                        readonly    value="{{ $wheat_data->firstthelaratedifference }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thela1TotalDifference"
                                                        ...
                                                        placeholder="1st Thela Total Difference" readonly   value="{{ $wheat_data->firstthelatotaldifference }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thela2Difference" class="form-control"
                                                        ...
                                                        value="{{ $wheat_data->secondtheladifference }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thela2RateDifference" class="form-control"
                                                        ...
                                                        readonly   value="{{ $wheat_data->secondthelaratedifference }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="thela2TotalDifference"
                                                        ...
                                                        placeholder="2nd Thela Total Difference" readonly   value="{{ $wheat_data->secondthelatotaldifference }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="totalAmountDifference"
                                                        ...
                                                        placeholder="Total Amount Difference" readonly   value="{{ $wheat_data->totalamountdifference }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
