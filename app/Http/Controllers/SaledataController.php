...
class SaledataController extends Controller
{
    ...
    public function show_name_select(pakTrader $pakTrader)
    {
        ...
        return view('saleview', ['show_name_select' => $show_name_select]);
    }
    ...
    public function update_salepurchase_data(Request $request,$id,)
    {
        ...
        $resone = DB::table('leadgers')->where('inv_id', $id)->update($datatwo);



        $ViewsPage = DB::select("SELECT * FROM pak_traders");
        $account = DB::table('addaccounts')->get();
        return view('saleview')->with(compact('ViewsPage', 'account'));
    }
    ...
    public function edit_salepurchase_data(Request $request, $id)
    {
        ...
        return view('saleedit')->with(compact('wheat_data', 'group_show_edit',));
    }
